...
namespace PlanGenerator
{
    ...
    public partial class AdventureWorksEntities : DbContext
    {
        ...
        public virtual DbSet<RfcVersionHistory> RfcVersionHistories { get; set; }
        ...
        public virtual ObjectResult<uspGetUserPhone_Result> uspGetUserPhone(Nullable<int> businessEntityID)
        {
            var businessEntityIDParameter = businessEntityID.HasValue ?
                new ObjectParameter("BusinessEntityID", businessEntityID) :
                new ObjectParameter("BusinessEntityID", typeof(int));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<uspGetUserPhone_Result>("uspGetUserPhone", businessEntityIDParameter);
        }
